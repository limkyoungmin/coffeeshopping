...
public class PagingUtil {
	...
	public PagingUtil(String keyWord, int currentPage, int totalCount, int blockCount, int blockPage,String pageUrl) {
		this(null,currentPage,totalCount,blockCount,blockPage,pageUrl,null);
	}
	public PagingUtil(String keyWord, int currentPage, int totalCount, int blockCount, int blockPage,String pageUrl,String addKey) {
		...
		if (currentPage > blockPage) {//11>10
			if(keyWord==null){//검색 미사용시
				...
				pagingHtml.append("<a href="+pageUrl+"?keyWord="+keyWord+"&pageNum="+ (startPage - 1) + addKey +">");
			}
		...
		for (int i = startPage; i <= endPage; i++) {
			...
			if (i == currentPage) {
				...
				if(keyWord==null){//검색 미사용시
					...
					pagingHtml.append("&nbsp;<a href='"+pageUrl+"?keyWord="+keyWord+"&pageNum=");
				}
				pagingHtml.append(i);
		...
		if (totalPage - startPage >= blockPage) {
			if(keyWord==null){//검색 미사용시
				...
				pagingHtml.append("<a href="+pageUrl+"?keyWord="+keyWord+"&pageNum="+ (endPage + 1) + addKey +">");
			}
