							...
							<table class="table text-center" id="memberTable">
								<thead>
									<tr class="text-white bg-dark">
										...
										<th class="col-2">탈퇴</th>
									</tr>
								</thead>
								<tbody>
									<c:forEach var="adminUserList" items="${adminUserList}">
											<tr class="table-ho">
												<td data-users-id="${adminUserList.users_id}">${adminUserList.users_id}</td> 
												<td>${adminUserList.users_name}</td>
												<td>${adminUserList.users_phone}</td>
												<td>${adminUserList.users_email}</td>
												<td>${adminUserList.users_date}</td>
												<td>${adminUserList.users_yn}</td>
												<td>
