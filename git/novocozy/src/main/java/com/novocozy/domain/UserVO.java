...
public class UserVO {
	...
	public String toString() {
		return "UserVO [users_id=" + users_id + ", users_passwd=" + users_passwd + ", users_name=" + users_name
				+ ", users_date=" + users_date + ", users_birthday=" + users_birthday + ", users_email=" + users_email
				+ ", users_email_yn=" + users_email_yn + ", users_email_code=" + users_email_code + ", users_phone="
				+ users_phone + ", users_yn=" + users_yn + ", users_zonecode=" + users_zonecode + ", users_address="
				+ users_address + ", users_addressdetail=" + users_addressdetail + "]";
	}
